...
function hellish_comments_navigation( $id = '' ) {
	...
	<nav role="navigation" id="<?php echo esc_attr( $id ); ?>" class="site-navigation comment-navigation">
		<h1 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'arousingaudio' ); ?></h1>
		<div class="nav-previous"><?php previous_comments_link( esc_html__( '&larr; Older Comments', 'arousingaudio' ) ); ?></div>
		<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments &rarr;', 'arousingaudio' ) ); ?></div>
...
if (
	...
	echo '<p class="nocomments">' . esc_html__( 'Comments are closed.', 'arousingaudio' ) . '</p>';
}
